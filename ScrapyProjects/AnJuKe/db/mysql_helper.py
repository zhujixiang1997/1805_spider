...
from ScrapyProjects.FangTianXia.FangTianXia.db.mysql_helper import DB_SET_MAP

mysql_conn_str = f"mysql+pymysql://{DB_SET_MAP['user']}:{DB_SET_MAP['passwd']}@{DB_SET_MAP['host']}:{DB_SET_MAP['port']}/{DB_SET_MAP['db']}?charset=utf8"
