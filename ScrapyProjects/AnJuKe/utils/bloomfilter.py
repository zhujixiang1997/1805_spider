...
from mycrawlspider.settings import REDIS_MAP
pool = redis.ConnectionPool(host=REDIS_MAP['host'], port=REDIS_MAP['port'], db=REDIS_MAP['db'])
...
if __name__ == "__main__":
    ...
    bf.add('www.sina.com')
    print(bf.is_exist('www.sina.com'))
